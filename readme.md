...
- Bitcoin
  ...
  - [Swap Online](https://swap.online) ([source code](https://github.com/swaponline), [white paper](https://wiki.swap.online/en.pdf)) - Protocol for decentralized exchange of Bitcoin, Ethereum and assets using Atomic Swap
- Ethereum
